...
export const travelMotivations: MotivationDefinition[] = [
  { key: 'restoration', label: 'Restoration', description: 'To relax and take a breather from my daily work/stressers.' },
  ...
  { key: 'escapism', label: 'Escapism', description: 'To experience a different world/reality from my everyday life.' },
